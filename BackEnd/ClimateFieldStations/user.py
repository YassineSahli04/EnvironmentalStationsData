...
from BackEnd.ClimateFieldStations.station import get_station_data_in_timestamp, get_station_info
from BackEnd.ClimateFieldStations.transform_data import transform_data_to_df_or_csv, combine_dfs_with_same_timestamp
...
def get_all_user_stations_info_geojson():
    ...
    for st in stations:
        feature = get_station_info(st["name"]["original"], isGeoJsonFeature=True) # type: ignore
